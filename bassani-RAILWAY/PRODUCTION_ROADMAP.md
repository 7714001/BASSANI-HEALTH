...
- [x] Known limitation, surfaced directly in the modal's empty state: orders placed before this multi-warehouse deploy have no `warehouse_id`, so they won't appear in a warehouse-scoped drill-down even though they may still hold stock
