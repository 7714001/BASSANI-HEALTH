...
const R_STATUS_COLOR = {
  quote: "amber", sale_order: "amber", awaiting_deposit: "amber", confirmed_wip: "teal",
  ...
  const submitQuote = async () => {
    ...
    try {
      if (quoteMode === "edit") {
        ...
        // and edit the draft before it's ready to go out). Sending is now
        // only ever a deliberate Send Quote click, same as Edit Quote.
  ...
  if (view === "detail") {
    ...
    return (
      <div className="flex flex-col flex-1 overflow-hidden bg-slate-50">
        ...
        {/* 8.46 — Make Recurring setup modal */}
        {recurringModalOpen && (
