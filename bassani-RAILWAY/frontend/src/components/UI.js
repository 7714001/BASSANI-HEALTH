...
import {
  ...
  Layers, Archive, PackageCheck, FolderTree, ArrowLeftRight,
} from "lucide-react";
...
const NAV = [
  ...
  { label: "Products", icon: Package, section: "Main", children: [
    ...
    { label: "Category Mapping",  path: "/catalogue/category-mapping",   icon: ArrowLeftRight, permission: "products.manage" },
  ]},
  ...
  { label: "Scripts",      path: "/scripts",     icon: ScrollText,      section: "Insights", adminOnly: true },
