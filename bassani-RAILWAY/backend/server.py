...
from routes.variant_alias_routes      import router as variant_alias_router
...
for router in [
    ...
    reseller_catalog_router, parent_category_router, variant_alias_router, supplier_router, settings_router,
