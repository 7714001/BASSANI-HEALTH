"""
Microsoft Graph API client for the orders@bassanihealth.com shared mailbox.
...
All public functions return None / raise httpx.HTTPStatusError on failure.
"""
import base64
import logging
import time
...
async def list_messages(
    ...
    mailbox = settings.ms_shared_mailbox
...
async def list_attachments(message_id: str) -> list:
    mailbox = settings.ms_shared_mailbox
